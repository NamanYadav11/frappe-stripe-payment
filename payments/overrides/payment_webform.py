...
#     try:
#         # Fetch the customer document using the provided customer ID
#         lead_doc = frappe.get_doc("Lead", {"custom_customer_stripe_id": customer_id})
...
#         # Save the payment method ID in the Customer document
...
#         frappe.log_error(message=str(e), title="Save Payment Method Error")
